...
\begin{lemma}\label{lem:isLocalizingSequence_ae}
  \uses{def:localizingSequence}
  \leanok
  \lean{ProbabilityTheory.isLocalizingSequence_localizingSequenceOfProp}
...
\begin{lemma}\label{lem:ProgMeasurable.hasStronglyMeasurableSup}
  \uses{def:ProgMeasurable}
  \leanok
  \lean{MeasureTheory.ProgMeasurable.hasStronglyMeasurableSupProcess}
...
\begin{proof}\leanok
  \uses{lem:isStoppingTime_leastGT}
...
Combine Lemma~\ref{lem:Integrable.classDL} and Lemma~\ref{lem:locally_mono}. Use Lemma~\ref{lem:isStable_progMeasurable} to get progressive measurability of the stopped processes.
\end{proof}
...
\begin{lemma}\label{lem:isLocalizingSequence_leastGE}
  \uses{def:leastGE, def:localizingSequence, def:IsCadlag, def:rightContinuous}
  \leanok
  \lean{ProbabilityTheory.isLocalizingSequence_leastGE}
...
\begin{lemma}\label{lem:sup_stoppedProcess_le}
  ...
  \leanok
  \lean{ProbabilityTheory.sup_stoppedProcess_leastGE_le}
...
\begin{lemma}\label{lem:locally_classDL_iff_locallyIntegrableSup}
  \uses{def:classDL, def:locallyIntegrableSup, def:locally, def:IsCadlag, def:rightContinuous}
  \leanok
  \lean{ProbabilityTheory.locally_classDL_iff_hasLocallyIntegrableSup}
Assume $T$ has a bottom element and that its closed intervals are compact, and that the filtration is right-continuous.
...
\begin{lemma}\label{lem:locally_classD_iff_locally_classDL}
  ...
  \leanok
  \lean{ProbabilityTheory.locally_classD_iff_locally_classDL}
Assume $T$ has a bottom element and that its closed intervals are compact, and that the filtration is right-continuous.
...
\begin{lemma}\label{lem:locally_classD_iff_locallyIntegrableSup}
  ...
  \leanok
  \lean{ProbabilityTheory.locally_classD_iff_hasLocallyIntegrableSup}
Assume $T$ has a bottom element and that its closed intervals are compact, and that the filtration is right-continuous.
...
\begin{lemma}\label{lem:Submartingale.locally_classD}
  ...
  \leanok
  \lean{MeasureTheory.Submartingale.locally_classD}
Every cadlag submartingale is locally of class D.
\end{lemma}

\begin{proof}
  \uses{lem:Submartingale.classDL, lem:locally_classD_iff_locally_classDL}
  \leanok
By Lemma~\ref{lem:locally_classD_iff_locally_classDL}, it suffices to show that every cadlag submartingale is locally of class DL.
This can be proved with Lemma~\ref{lem:Submartingale.classDL}.
\end{proof}
...
\begin{lemma}\label{lem:IsLocalSubmartingale.locally_classD}
  ...
  \leanok
  \lean{ProbabilityTheory.IsLocalSubmartingale.locally_classD}
