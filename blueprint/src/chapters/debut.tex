...
\begin{theorem}\label{thm:fst_iInter_of_supClosure_memProd_of_antitone}
  \uses{def:IsCompactSystem, def:supClosure, def:memProd}
  \leanok
  \lean{MeasureTheory.fst_iInter_of_supClosure_memProd_of_antitone}
...
\begin{definition}[Analytic set]\label{def:IsPavingAnalytic}
  \uses{def:IsCompactSystem, def:countableSupClosure, def:countableInfClosure, def:memProd}
  \leanok
...
\begin{proof}\leanok
  \uses{thm:fst_iInter_of_supClosure_memProd_of_antitone}
...
\begin{lemma}\label{lem:memDelta_fst}
  \uses{def:countableInfClosure, def:memProd, def:IsCompactSystem}
  \leanok
...
\begin{proof}\leanok
  \uses{thm:fst_iInter_of_supClosure_memProd_of_antitone, lem:InfClosed.mem_countableInfClosure_iff}
...
\begin{proof}\leanok
  \uses{lem:isCapacitable_memDelta_memSigma, lem:IsCompactSystem.infClosure, lem:IsCapacitable.fst}
