...
\begin{lemma}\label{lem:memDelta_iff_of_inter}
  \uses{def:memDelta}
  \leanok
  \lean{MeasureTheory.memDelta_iff_of_infClosed}
...
\begin{lemma}\label{lem:memSigma_iff_of_union}
  \uses{def:memSigma}
  \leanok
  \lean{MeasureTheory.memSigma_iff_of_supClosed}
...
\begin{lemma}\label{lem:IsCompactSystem.memDelta}
  \uses{def:IsCompactSystem, def:memDelta}
...
\begin{proof}
  \uses{lem:IsCompactSystem.mono, lem:IsCompactSystem.memDelta}
$S_\delta$ is a compact system by Lemma~\ref{lem:IsCompactSystem.memDelta}, and $S^{\cap f} \subseteq S_\delta$, so we can apply Lemma~\ref{lem:IsCompactSystem.mono}.
\end{proof}
...
\begin{lemma}\label{lem:isPavingAnalytic_fst_of_memProd_measurableSet_Icc}
  \uses{def:IsPavingAnalytic}
  \leanok
  \lean{MeasureTheory.isPavingAnalytic_fst_of_memProd_measurableSet_Icc}
...
\begin{proof}\leanok
  \uses{lem:MeasurableSet.isPavingAnalytic_memProd, lem:isPavingAnalytic_fst_of_memProd_measurableSet_Icc}
...
%   \leanok
%   \lean{MeasureTheory.empty_mem_𝓚₀, MeasureTheory.inter_mem_𝓚₀, MeasureTheory.subset_Iic_of_mem_𝓚₀}
%   \uses{def:subsets_compact_RNN_times_measurable}
...
%   \leanok
%   \lean{MeasureTheory.measurableSet_snd_of_mem_𝓚₀}
%   \uses{def:subsets_compact_RNN_times_measurable}
...
%   \leanok
%   \lean{MeasureTheory.empty_mem_𝓚, MeasureTheory.inter_mem_𝓚, MeasureTheory.union_mem_𝓚, MeasureTheory.subset_Iic_of_mem_𝓚, MeasureTheory.𝓚₀_subset_𝓚}
%   \uses{def:fin_union_RNN_times_measurable}
...
%   \leanok
%   \lean{MeasureTheory.empty_mem_𝓚δ, MeasureTheory.union_mem_𝓚δ, MeasureTheory.inter_mem_𝓚δ, MeasureTheory.iInter_mem_𝓚δ, MeasureTheory.subset_Iic_of_mem_𝓚δ, MeasureTheory.𝓚_subset_𝓚δ}
%   \uses{def:count_inter_of_fin_union_RNN_times_measurable}
...
For a process $X : T \to Ω \to E$ and a real number $a$, define the random time
\begin{align*}
...
If $X : T \to Ω \to E$ is a progressively measurable process with respect to a filtration satisfying the usual conditions, then for any $a \in E$, the random time $\tau_{X \ge a}$ is a stopping time.
\end{lemma}
...
If $X : T \to Ω \to E$ is a progressively measurable process with respect to a filtration satisfying the usual conditions, then for any $a \in E$, the random time $\tau_{X > a}$ is a stopping time.
\end{lemma}
